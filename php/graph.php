...
,{State:'90~120',freq:{Other:<?php echo $sportTimeBetween90to120Count["Other"]?>, Archery:<?php echo $sportTimeBetween90to120Count["Archery"]?>, Athletics:<?php echo $sportTimeBetween90to120Count["Athletics"]?>, Badminton:<?php echo $sportTimeBetween90to120Count["Badminton"]?>, Basketball:<?php echo $sportTimeBetween90to120Count["Basketball"]?>, BeachVolleyball:<?php echo $sportTimeBetween90to120Count["BeachVolleyball"]?>, Cycling:<?php echo $sportTimeBetween90to120Count["Cycling"]?>, Diving:<?php echo $sportTimeBetween90to120Count["Diving"]?>, Equestrian:<?php echo $sportTimeBetween90to120Count["Equestrian"]?>, Fencing:<?php echo $sportTimeBetween90to120Count["Fencing"]?>, Football:<?php echo $sportTimeBetween90to120Count["Football"]?>, Gymnastics:<?php echo $sportTimeBetween90to120Count["Gymnastics"]?>, Handball:<?php echo $sportTimeBetween90to120Count["Handball"]?>, Hockey:<?php echo $sportTimeBetween90to120Count["Hockey"]?>, Judo:<?php echo $sportTimeBetween90to120Count["Judo"]?>, Rowing:<?php echo $sportTimeBetween90to120Count["Rowing"]?>, Sailing:<?php echo $sportTimeBetween90to120Count["Sailing"]?>, Shooting:<?php echo $sportTimeBetween90to120Count["Shooting"]?>, Swimming:<?php echo $sportTimeBetween90to120Count["Swimming"]?>, SynchronisedSwimming:<?php echo $sportTimeBetween90to120Count["SynchronisedSwimming"]?>, TableTennis:<?php echo $sportTimeBetween90to120Count["TableTennis"]?>, Taekwondo:<?php echo $sportTimeBetween90to120Count["Taekwondo"]?>, Tennis:<?php echo $sportTimeBetween90to120Count["Tennis"]?>, Trampoline:<?php echo $sportTimeBetween90to120Count["Trampoline"]?>, Volleyball:<?php echo $sportTimeBetween90to120Count["Volleyball"]?>, WaterPolo:<?php echo $sportTimeBetween90to120Count["WaterPolo"]?>, Weightlifting:<?php echo $sportTimeBetween90to120Count["Weightlifting"]?>, Wrestling:<?php echo $sportTimeBetween90to120Count["Wrestling"]?>}}
