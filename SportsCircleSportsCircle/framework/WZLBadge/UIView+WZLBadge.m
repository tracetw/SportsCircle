...
- (void)badgeInit
{
    ...
    if (nil == self.badge) {
        ...
        self.badge.center = CGPointMake(self.width / 1.4 + self.badgeCenterOffset.x, self.badgeCenterOffset.y +8);
...
//    CGSize labelsize =
//    [s sizeWithFont:font constrainedToSize:size lineBreakMode:NSLineBreakByWordWrapping];
